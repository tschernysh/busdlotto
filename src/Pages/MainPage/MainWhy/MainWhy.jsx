  ...
  return (
    <div className='mt-20 max-w-screen-mmx mx-auto after__block_line'>
      ...
      <div className='flex flex-col gap-y-36 mb-16'>
        ...
        <div className='fade__block_right relative font-poppins400 text-5xl text-white p-10 z-10'>
          <div className='w-3/4'>
            <h3 className='mb-8 font-inter800 text-5xl text-title'>Anonymous</h3>
            <p className='font-poppins400 text-3xl text-description mb-5'>
          ...
          <img className='absolute right-0 bottom-0 ' src={Anonymous} />
        </div>

        <div className='fade__block_left flex justify-end relative font-poppins400 text-5xl text-white p-10 z-10'>
          <img className='absolute left-0 bottom-0 ' src={Chain} />
          <div className='w-3/4 text-right'>
            <h3 className='mb-8 font-inter800 text-5xl text-title'>Transparent</h3>
            <p className='font-poppins400 text-3xl text-description mb-5'>
        ...
        <div className='fade__block_right relative font-poppins400 text-5xl text-white p-10 z-10'>
          <div className='w-3/4'>
            <h3 className='mb-8 font-inter800 text-5xl text-title'>100K win</h3>
            <p className='font-poppins400 text-3xl text-description mb-5'>
          ...
          <img className='absolute right-0 bottom-0 ' src={HundredK} />
        </div>

        <div className='fade__block_left flex justify-end relative font-poppins400 text-5xl text-white p-10 z-10'>
          <img className='absolute left-0 bottom-0 ' src={Coins} />
          <div className='w-3/4 text-right'>
            <h3 className='mb-8 font-inter800 text-5xl text-title'>Crosschain capability</h3>
            <p className='font-poppins400 text-3xl text-description mb-5'>
        ...
        <div className='fade__block_right relative font-poppins400 text-5xl text-white p-10 z-10'>
          <div className='w-3/4'>
            <h3 className='mb-8 font-inter800 text-5xl text-title'>60% goes to the prize pool</h3>
            <p className='font-poppins400 text-3xl text-description mb-5'>
          ...
          <img className='absolute right-0 bottom-0 ' src={Cup} />
        </div>

        <div className='fade__block_left flex justify-end relative font-poppins400 text-5xl text-white p-10 z-10'>
          <img className='absolute left-0 bottom-0 ' src={Megaphone} />
          <div className='w-3/4 text-right'>
            <h3 className='mb-8 font-inter800 text-5xl text-title'>3-level referral program</h3>
            <p className='font-poppins400 text-3xl text-description mb-5'>

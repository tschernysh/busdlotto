  ...
  return (
    <div className='mt-20 max-w-screen-mmx mx-auto '>
      ...
      <div className='flex items-center justify-between gap-x-12 mb-24'>
        <div>
          <div className='w-44 h-44 work__circles flex items-center justify-center'>
            <img src={Finger} />
          </div>
          <p className='font-poppins400 text-white text-xl w-10/12 mx-auto mt-4' >Press “BUY TICKET”</p>
        </div>
        <img src={Arrow} />
        <div>
          <div className='w-44 h-44 work__circles flex items-center justify-center'>
          ...
          <p className='font-poppins400 text-white text-xl w-10/12 mx-auto mt-4' >Connect your wallet</p>
        </div>
        <img src={Arrow} />
        <div>
          <div className='w-44 h-44 work__circles flex items-center justify-center'>
          ...
          <p className='font-poppins400 text-white text-xl w-10/12 mx-auto mt-4' >Pay with your preferred cryptocurrency</p>
        </div>
        <img src={Arrow} />
        <div>
          <div className='w-44 h-44 work__circles flex items-center justify-center'>
          ...
          <p className='font-poppins400 text-white text-xl w-10/12 mx-auto mt-4' >GET READY TO WIN!!!</p>
        </div>
      </div>

    ...
    <div className='mt-20 max-w-screen-mmx mx-auto '>
      ...
      <div className='fade__block_right p-10'>
        ...
        <p className='text-description font-poppins400 text-2xl sm:text-3xl mb-5'>
          <span className='text-gold font-poppins600'>6 USDT</span> goes to the lottery fund (you can check the lottery fund wallet <a href={fundWalletLink} className='text-gold font-poppins600 no-underline' target='_blank' >here</a>).
        </p>
        <p className='text-description font-poppins400 text-2xl sm:text-3xl mb-5'>

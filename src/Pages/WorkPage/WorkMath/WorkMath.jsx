...
export const WorkMath = () => {
  ...
  return (
    <div className='mt-20 max-w-screen-mmx mx-auto '>
      <h1 className='font-inter800 text-5xl sm:text-7xl mb-10 text-white'>
        Simple Math
      </h1>
      <div className='fade__block_right p-10'>
        <h3 className='font-poppins400 text-title text-3xl sm:text-5xl mb-8'>For every <span className='text-gold'>10 USDT</span> lottery ticket purchased, the amount is allocated as follows:</h3>

  ...
  return (
    <div className='pt-20 max-w-screen-mmx mx-auto text-center z-10 relative'>
      ...
      <div className='w-full px-4 sm:px-0 sm:w-1/2 mx-auto text-center'>
        ...
        <div className='font-poppins400 rounded-2xl text-xl sm:text-3xl text-description py-5 px-4 sm:py-8 sm:px-10 bg-blue'>Your wallet address: {walletToShow}</div>
      </div>
    </div>
  )
}

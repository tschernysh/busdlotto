...
export const BoughtModal = () => {
  ...
  return (
    <div className='fixed w-screen h-screen left-0 top-0 backdrop-brightness-50 flex backdrop-blur-md items-center justify-center bought__ticket_bg'>
      <div className='w-full mx-4 sm:mx-0 sm:w-2/3 z-10  bought__ticket_modal  rounded-3xl relative text-center py-10 px-8'>
